...
// Removes all filters and refreshes the data table
...
//Use this function to filter the table when data is entered.
  ...
  function filterTable() {
    ...
    //filteredFilters = filteredFilters.filter(row => row.this === filters)
    data.forEach((dataRow) => {
      if (date) {
    ...
    // if (elementValue) {filteredFilters = filteredFilters.filter(row => filters === elementValue);
    })
    // Rebuild the table using the filtered data
    buildTable(filteredFilters)
  };
